...
select trips_unioned.tripid, 
    ...
    concat(cast(extract(year from trips_unioned.pickup_datetime) as string), '/Q', cast(extract(quarter from trips_unioned.pickup_datetime) as string)) as year_quarter
